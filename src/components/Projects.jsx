...
const projectData = [
    {
        ...
        image: <img src={scrummyFish} alt="Scrummy Fish" width={'10%'}></img>,
        borderColor: 'blue'
    }, {
        ...
        image: <img src={gameChipLogo} alt="GameChip Logo" width={'10%'}></img>,
        borderColor: 'pink'
    }, {
        ...
        image: <img src={thoughtBubble} alt="Thought Bubble" width={'10%'}></img>,
        borderColor: 'red'
    }, {
        ...
        image: <img src={catDog} alt="CatDog" width={'10%'}></img>,
        borderColor: 'orange'
    }
];
